...
public class Spherical_chart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spherical_chart);
        createnegativelist();
        createpositivelist();
        setAdapter();
    ...
    private void createnegativelist() {
        ...
        for(double i=-0.25;i>=-12.75;i-=0.25){
    ...
    private void createpositivelist() {
        ...
        for(double i=0.25;i<=8.00;i+=0.25){
